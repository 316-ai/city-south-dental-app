          ...
          <div className="blogs px-3 py-7 lg:py-12 bg-white">
            <div className="lg:container mx-auto">
              <div>
                ...
                <h2 className="text-md font-normal text-gray-900 mb-4">
              ...
              <ul className="list-disc list-inside text-gray-600 mb-4 font-normal">
              ...
              <div className="mb-5">
                ...
                <p className="text-sm text-gray-600 font-normal mb-2 mt-2">
                  * Additional fees – The CDCP fees may not be the same as what
                  providers charge and only pays for services covered winormal the
