          ...
          <div className="grid grid-cols-8 gap-12 md:gap-8">
            ...
            <div className="col-span-8 md:col-span-5 lg:col-span-4 flex flex-col justify-center">
              ...
              <p className="text-sm text-gray-600 font-thin mb-5">
                At City South Dental, we are dedicated to providing top-notch
                dental care to the Brampton community. Our skilled dental
                professionals use the latest technology to offer comprehensive
                and personalized treatments. From preventive care to advanced
                dental procedures, we are committed to helping you achieve
                optimal oral health.
              </p>
              <p className="text-sm text-sky-900 mb-5">
                Our services include cosmetic dentistry, orthodontics, dental
                implants, and emergency dental care. We pride ourselves on
                creating a welcoming environment for all our patients. Your
