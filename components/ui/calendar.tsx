  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-sky-600 text-neutral-50 hover:bg-sky-600 hover:text-white focus:bg-sky-600 focus:text-neutral-50",
        day_today:
          "bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
          "day-outside text-neutral-100 opacity-50 aria-selected:bg-neutral-100/50 aria-selected:text-neutral-500 aria-selected:opacity-30 dark:text-neutral-400 dark:aria-selected:bg-neutral-800/50 dark:aria-selected:text-neutral-400",
